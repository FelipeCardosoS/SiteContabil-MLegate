...
{
    public partial class EmitenteRecebimentoTableAdapter
    {
        public RelatoriosDAO.EmitenteRecebimentoDataTable GetData(string Page_IsPostBack, string Emitentes_Selecionados, string Tomadores_Selecionados, string De_Rec, string Ate_Rec, string De, string Ate, string Ordenacao)
        {
            ...
            sql += "ON NF_R.COD_RETENCAO = CR.COD_RETENCAO, LANCTOS_CONTABEIS LC ";
            ...
            RelatoriosDAO.EmitenteRecebimentoDataTable tb = new RelatoriosDAO.EmitenteRecebimentoDataTable();
