<%@ Page Language="C#" MasterPageFile="~/MasterGrid.master" StylesheetTheme="principal" AutoEventWireup="true" CodeFile="FormGridLanctosContasReceber.aspx.cs" Inherits="FormGridLanctosContasReceber" %>
...
<asp:Content ID="_areaFiltro" ContentPlaceHolderID="areaFiltro" runat="server">
    ...
    <label><span>Cod. Planilha</span>
        <asp:TextBox ID="textcodplanilha" Width="80px" runat="server"></asp:TextBox>     
    </label>
    <label>
