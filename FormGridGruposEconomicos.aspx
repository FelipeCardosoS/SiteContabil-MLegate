<%@ Page Title="" Language="C#" MasterPageFile="~/MasterGrid.master" AutoEventWireup="true" CodeFile="FormGridGruposEconomicos.aspx.cs" Inherits="FormGridGruposEconomicos" StylesheetTheme="principal" %>
                ...
                <tr class="linha">
                    <td class="check line" width="1%">
                        <input type="checkbox" id="check" class="check" name="check" 
                            value='<%# DataBinder.Eval(Container.DataItem, "[COD_GRUPO_ECONOMICO]") %>' runat="server" />
                    </td>
