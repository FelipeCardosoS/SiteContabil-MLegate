...
public partial class FormGridGruposEconomicos : BaseGridForm
{
    GrupoEconomico grupoEconomico;
    DataTable tableGrupos;
    public FormGridGruposEconomicos()
    : base("GRUPO_ECONOMICO")
    {
        grupoEconomico = new GrupoEconomico(_conn);
        tableGrupos = new DataTable("grupo_economico");
    }
    ...
    protected override void montaGrid()
    {
        ...
        totalRegistros = grupoEconomico.totalRegistros(descricao);
        grupoEconomico.lista(ref tableGrupos, paginaAtual, descricao, ordenacao);
    ...
    protected override void montaTela()
    {
        ...
        this.Title += "Grupos Econômicos";
        subTitulo.Text = "Grupos Econômicos";
        botaoNovo.NavigateUrl = "FormEditCadGruposEconomicos.aspx";
    ...
    protected override void repeaterDados_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        if (e.Item.ItemType != ListItemType.Separator)
        {
            ...
            linkAlterar.NavigateUrl = "FormEditCadGruposEconomicos.aspx?id=" + check.Value;
        }
    }
    ...
    protected override void botaoDeletar_Click(object sender, EventArgs e)
    {
        ...
        {
            grupoEconomico.codigoGrupoEconomico = Convert.ToInt32(selecionados[i]);
            try
            {
                grupoEconomico.deletar();
            }
            catch
            {
