<%@ Page Title="" Language="C#" MasterPageFile="~/MasterForm.master" StylesheetTheme="principal" AutoEventWireup="true" CodeFile="FormRelatorioEmitenteFaturamento.aspx.cs" Inherits="FormRelatorioEmitenteFaturamento" %>
...
<asp:Content ID="areaConteudo" ContentPlaceHolderID="areaConteudo" runat="Server">
    ...
    <div style="width:1000px;">
        ...
        <div style="margin-top:10px;">
            <div style="text-align:center; width:315px; float:left; display:inline-table; margin-right:100px;">
            ...
            <div>
                <select id="ddlOrdenacao" style="width:200px; margin-top:15px; margin-bottom:15px; margin-right:80px;" runat="server">
                    <option value="0">Ordenar por:</option>
                    <option value="NF.NOME_RAZAO_SOCIAL_EMITENTE, NF.COD_EMITENTE, NF.DATA_EMISSAO_RPS, NF.NUMERO_RPS">Emitente</option>
                    <option value="NF.DATA_EMISSAO_RPS, DATA_RECEBIMENTO, NF.NUMERO_RPS, NF.NOME_RAZAO_SOCIAL_EMITENTE, NF.COD_EMITENTE">Data Faturamento</option>
                    <option value="DATA_RECEBIMENTO, NF.NUMERO_RPS, NF.NOME_RAZAO_SOCIAL_EMITENTE, NF.COD_EMITENTE, NF.DATA_EMISSAO_RPS">Data Recebimento</option>
    ...
    <div style="height:475px; margin-top:10px;">
        <rsweb:ReportViewer ID="rptEmitenteFaturamento" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt" 
            Width="100%" Height="100%" SizeToReportContent="True" OnReportRefresh="rptEmitenteFaturamento_ReportRefresh" runat="server">
            <LocalReport ReportPath="Relatorios\EmitenteFaturamento.rdlc" EnableHyperlinks="True">
                <DataSources>
                    <rsweb:ReportDataSource DataSourceId="DataSourceEmitenteFaturamento" Name="dsEmitenteFaturamento" />
                    <rsweb:ReportDataSource DataSourceId="DataSourceTotalValorBruto" Name="dsTotalValorBruto" />
                </DataSources>
            </LocalReport>
        </rsweb:ReportViewer>

        <asp:ObjectDataSource ID="DataSourceEmitenteFaturamento" runat="server" OldValuesParameterFormatString="original_{0}" 
            SelectMethod="GetData" TypeName="RelatoriosDAOTableAdapters.EmitenteFaturamentoTableAdapter">
            <SelectParameters>
        ...
        <asp:ObjectDataSource ID="DataSourceTotalValorBruto" runat="server" OldValuesParameterFormatString="original_{0}" 
            SelectMethod="GetData" TypeName="RelatoriosDAOTableAdapters.TotalValorBrutoTableAdapter">
            <SelectParameters>
                <asp:ControlParameter ControlID="tbxPage_IsPostBack" Name="Page_IsPostBack" PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="tbxEmitente" Name="Emitentes_Selecionados" PropertyName="Value" Type="String" />
                <asp:ControlParameter ControlID="tbxTomador" Name="Tomadores_Selecionados" PropertyName="Value" Type="String" />
