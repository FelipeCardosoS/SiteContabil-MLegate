<%@ Page Language="C#" MasterPageFile="~/MasterGrid.master" StylesheetTheme="principal" AutoEventWireup="true" CodeFile="FormGridPerfisAcesso.aspx.cs" Inherits="FormGridPerfisAcesso" %>
                ...
                <tr class="linha">
                    <td class="check line">
                        <input type="checkbox" id="check" class="check" name="check" 
                            value='<%# DataBinder.Eval(Container.DataItem, "[COD_PERFIL]") %>' runat="server" />
