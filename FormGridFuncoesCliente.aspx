<%@ Page Language="C#" MasterPageFile="~/MasterGrid.master" StylesheetTheme="principal" AutoEventWireup="true" CodeFile="FormGridFuncoesCliente.aspx.cs" Inherits="FormGridFuncoesCliente" %>
...
<asp:Content ID="_areaFiltro" ContentPlaceHolderID="areaFiltro" runat="server">
    <label><span>Descrição</span>
        <asp:TextBox ID="textDescrição" Width="220px" runat="server"></asp:TextBox>
    </label>
</asp:Content>
                ...
                <tr class="linha">
                    <td class="check line" width="1%">
                        <input type="checkbox" id="check" class="check" name="check" 
                            value='<%# DataBinder.Eval(Container.DataItem, "[COD_FUNCAO]") %>' runat="server" />
                    </td>
