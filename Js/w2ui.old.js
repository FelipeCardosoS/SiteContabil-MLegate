...
var w2utils = (function () {
    ...
    var obj = {
        ...
        settings : {
            ...
            "float": "^[-+]?[0-9]*[\\.,]?[0-9]+$",
            "shortmonths": ["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"],
            "fullmonths": ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agostos", "Setembro", "Outubro", "Novembro", "Dezembro"],
            ...
            "phrases": {
                ...
                "Attach files by dragging and dropping or Click to Select": "Anexar arquivos arrastando e soltando ou clique para selecionar",
                "Remove": "Remover",
                "Not a valid date": "Data inválida",
                "Required field": "Campo requerido",
                "Saving...": "Salvando",
                "Not an integer": "Número não é um inteiro",
                "Not a float": "Número não é um ponto flutuante",
                "Not in money format": "Valor não está no formato de moeda",
                "Not a hex number": "Número não é hexadecimal",
                "Not alpha-numeric": "Valor não é alfanumérico",
                "Not a valid email": "Email inválido",
                "Are you sure you want to delete selected records?": "Tem certeza que deseja remover os registros selecionados?",
                "Return data is not in JSON format. See console for more information.": "Dados retornados não está no formato JSON. Verifique o console para mais informações",
                "Refreshing...": "Atualizando...",
                "All Fields": "Todos os campos",
                "Multi Fields": "Campos múltiplos",
                "Delete Confirmation": "Confirme",
                "Ok": "OK",
                "Yes": "Sim",
                "No": "N&atilde;o",
                "Reload data in the list": "Recarregar os dados na listagem",
                "Show/hide columns": "Exibir/ocultar colunas",
                "Select Search Field": "Campo de pesquisa",
                "Search...": "Pesquisar...",
                "Open Search Fields": "Campos de pesquisa abertos",
                "is": "é",
                ...
                "Delete selected records": "Remover registros selecionados",
                "Delete": "Remover",
                "Save changed records": "Salvar registros modificados",
                "Save": "Salvar",
                "Reset": "Resetar",
                "Search": "Pesquisar",
                ...
                "buffered": "armazenado",
                "Server Response": "Resposta do servidor em",
                "sec": "segundos",
                "Skip": "Saltar",
                "Records": "Registros",
                "Toggle Line Numbers": "Alternar números de linha",
                "Reset Column Size": "Reiniciar tamanho da coluna",
                "Edit": "Editar",
                "Load": "Carregar",
                "More": "Mais"
...
(function () {
    ...
    w2grid.prototype = {
        ...
        buttons: {
            ...
            'delete': { type: 'button', id: 'w2ui-delete', caption: w2utils.lang('Remover'), hint: w2utils.lang('Remover todos os lan&ccedil;amentos selecionados!'), icon: 'w2ui-icon-cross', disabled: true },
        ...
        searchShowFields: function () {
            ...
            for (var s = -1; s < this.searches.length; s++) {
                ...
                if (s == -1) {
                    ...
                    search = { field: 'all', caption: w2utils.lang('Todos os campos..') };
                } else {
        ...
        initColumnOnOff: function () {
            ...
            var col_html = '<div class="w2ui-col-on-off">' +
                            ...
                            //'    <label for="grid_'+ this.name +'_column_ln_check">'+ w2utils.lang('Nº de Linhas') +'</label>'+
                            //'</td></tr>';
            for (var c in this.columns) {
                var col = this.columns[c];
        ...
        scroll: function (event) {
            ...
            var url = (typeof this.url != 'object' ? this.url : this.url.get);
            $('#grid_' + this.name + '_footer .w2ui-footer-right').html("Lan&ccedil;amento(s): " + w2utils.formatNumber(this.total));
            //w2utils.formatNumber(this.total)
            //w2utils.formatNumber(this.offset + t1) + '-' + w2utils.formatNumber(this.offset + t2) + ' ' + w2utils.lang('of') + ' ' +    w2utils.formatNumber(this.total) +            (url ? ' (' + w2utils.lang('buffered') + ' ' + w2utils.formatNumber(buffered) + (this.offset > 0 ? ', skip ' + w2utils.formatNumber(this.offset) : '') + ')' : '')
            ...
            if (this.show.expandColumn) {
                ...
                rec_html +=
                        '<td id="grid_'+ this.name +'_cell_'+ ind +'_expand' + (summary ? '_s' : '') + '" class="w2ui-grid-data w2ui-col-expand">'+
                            (summary !== true ?
                            '    <div ondblclick="offExpand(event)" '+
                            '            onclick="offExpand(event, \'' + record.recid + '\');">' +
                            '        '+ tmp_img +' </div>'
                            :
                            '' ) +
                        '</td>';
    ...
    w2popup = {
        ...
        lockScreen: function (options) {
            ...
            $('body').append('<div id="w2ui-lock" ' +
                '    onmousewheel="offExpand(event) if (event.preventDefault) event.preventDefault(); else return false;"'+
...
(function () {
    ...
    w2toolbar.prototype = {
        ...
        render: function (box) {
            ...
            html += '<td id="tb_grid_toolbar_item_w2ui-break1" style="" class="" valign="middle"><table cellpadding="0" cellspacing="0"><tbody><tr><td><div class="w2ui-break">&nbsp;</div></td></tr></tbody></table></td><td width="100%" id="tb_' + this.name + '_right" align="right">' + this.right + '<div id="boxLoad"></div> <b>( Totais )</b> D&eacute;bito: <input id="cmbDebito" type="text" value="0,00" readonly="readonly"> Cr&eacute;dito: <input id="cmbCredito" type="text" value="0,00" readonly="readonly"> Diferen&ccedil;a: <input id="cmbDiferenca" type="text" value="0,00" readonly="readonly"></td>';
            html += '</tr>'+
                    '</table>';
            $(this.box)
                .attr('name', this.name)
            ...
            switch (this.type) {
                ...
                case 'combo':
                    ...
                    if (this.type == 'list') {
                        ...
                        defaults.suffix = '<div class="arrow-down" style="margin-top: ' + ((parseInt($(this.el).height()) - 6) / 2) + 'px; margin-top: 7px !important;margin-left: -3px;"></div>';
        ...
        updateOverlay: function () {
            ...
            if (['list', 'combo', 'enum'].indexOf(this.type) != -1) {
                ...
                if ($(input).is(':focus')) {
                    ...
                    var msgNoItems = w2utils.lang('Sem Resultados');
